...
function initialisePage(){
    ...
    if($db->connect_error){
        die("<html><body><h1> Error: Cannot connect to the database at this time </h1> <p>EduCode are sorry for the inconvinience, please try again later  </p></body></html>");
    ...
    if ($result -> num_rows <= 0){
        die("<html><body><h1> Error: No activities found for that language or topic </h1> <p>EduCode are sorry for the inconvinience, please try again later </p></body></html>");
        return 0;
    }
